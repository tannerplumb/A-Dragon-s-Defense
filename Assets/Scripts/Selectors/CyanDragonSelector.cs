...
public class CyanDragonSelector : MonoBehaviour
{
    public GameObject dragonToCreate;
    public GameObject backgroundRadius;

    public static int dragonCost = 2625;
    private string description = "An all-powerful dragon that attacks at hyper speed.";
