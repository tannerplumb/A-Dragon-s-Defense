...
public class PurpleDragon : MonoBehaviour
{
    [System.NonSerialized] public string Name = "Purple Dragon";
    [System.NonSerialized] public int Level = 1;
    [System.NonSerialized] public float AttackSpeed = 1.66f;
    [System.NonSerialized] public int Kills = 0;
    [System.NonSerialized] public int KillsToLevel = 100;
    [System.NonSerialized] public int Upgrade1Cost = 400;
    [System.NonSerialized] public bool Upgrade1Active = false;
    [System.NonSerialized] public int Upgrade2Cost = 800;
    [System.NonSerialized] public bool Upgrade2Active = false;
    [System.NonSerialized] public int Upgrade3Cost = 1200;
    ...
    private void AttackFireball(GameObject fireball)
    {
        ...
        else if (fireball.name.Contains("Yellow"))
        {
            ...
            newFireball.GetComponent<RedFireball>().MoveSpeed = newFireball.GetComponent<RedFireball>().MoveSpeed * 0.5f;
        ...
        else if (fireball.name.Contains("Blue"))
        {
            ...
            newFireball.GetComponent<FireballTimer>().time = fireball.GetComponent<FireballTimer>().time;
            newFireball.GetComponent<YellowFireball>().MoveSpeed = newFireball.GetComponent<YellowFireball>().MoveSpeed * 0.5f;
        ...
        else if (fireball.name.Contains("Green"))
        {
            ...
            newFireball.GetComponent<FireballTimer>().time = fireball.GetComponent<FireballTimer>().time;
            newFireball.GetComponent<BlueFireball>().MoveSpeed = newFireball.GetComponent<BlueFireball>().MoveSpeed * 0.5f;
        ...
        else if (fireball.name.Contains("White"))
        {
            ...
            newFireball.GetComponent<FireballTimer>().time = fireball.GetComponent<FireballTimer>().time;
            newFireball.GetComponent<GreenFireball>().MoveSpeed = newFireball.GetComponent<GreenFireball>().MoveSpeed * 0.5f;
        ...
        else if (fireball.name.Contains("Purple"))
        {
            ...
            fireball.GetComponent<PurpleFireball>().MoveSpeed = fireball.GetComponent<PurpleFireball>().SlowedSpeed;
        }
